                ...
                function i(e, t, n) {
                    if (e.RTCPeerConnection) {
                        ...
                        (r.removeEventListener = function (e, n) {
                            ...
                            return (
                                delete this._eventMap[n], i.apply(this, [e, r])
                            );
                        }),
                ...
                function m(t) {
                    if (t.RTCPeerConnection) {
                        ...
                        Object.defineProperty(
                            ...
                            (t.RTCPeerConnection.prototype.removeTrack =
                                function (e) {
                                    var t,
                                        r = this;
                                    if ('closed' === this.signalingState)
                    ...
                    function r() {
                        (this.CLOUD_HOST = '0.peerjs.com'),
                            ...
                            (this.supports = (function () {
                                ...
                                try {
                                    (r = new RTCPeerConnection(o)),
                                        (t.audioVideo = !0);
                                    var n = void 0;
                                    try {
                                        (n = r.createDataChannel(
                                            '_PEERJSTEST',
                                            { ordered: !0 }
                                        )),
                                            (t.data = !0),
                                    ...
                                    case u.ServerMessageType.Offer:
                                        ...
                                        if (
                                            ...
                                            (_ = new l.MediaConnection(
                                                ...
                                                this.emit(
                                                    u.PeerEventType.Call,
                                                    _
                                                );
                                        else {
                                            if (
                                                i.type !== u.ConnectionType.Data
                                            )
